...
%%% Save space in lists. Use this after the opening of the list %%%%%%%%%%%%%%%%
	...
	% Only simple background color used, no shading, so boxColorTwo isn't necessary
	    ...
	    \headerbox{Experiment}{name=res1,column=1,span=1,row=0}{
		%\begin{multicols}{2}
	    ...
	    \headerbox{Result}{name=result,column=2,row=0}{
	    ...
	    \headerbox{Concluding Remarks}{name=conclusion,column=2,below=result}{
