...
%%% Save space in lists. Use this after the opening of the list %%%%%%%%%%%%%%%%
	...
	% Only simple background color used, no shading, so boxColorTwo isn't necessary
	    ...
	    \headerbox{Framework}{name=ud,column=1,row=0}{
...
\end{algorithmic}
\end{algorithm}
		Given the prices attributed by the agents for each good ($V^i$), an exchange is made or not (l.13). Given the quantities ($Q^i$) gathered, a score reflecting the ``economic success'' of each agent is attributed (l.17). Finally the value attributed to each good $V^i$ is modified (l.19-20).
	    ...
	    \headerbox{Experiments \& Resuluts}{name=res1,column=0,span=2,below=ud}{
		\begin{multicols}{2}
		    \subsection*{Experimental Setup 1}
		    We carry out simulations in which cultural networks are complete. Every agent knows the strategy of the producers of its own good. 
	    		\begin{figure}[H]
		    \centering
		    \begin{tabular}{ c c}
